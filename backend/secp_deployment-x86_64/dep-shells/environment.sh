...
# 集群各机器 IP 数组
export NODE_IPS=(192.168.200.140 192.168.200.136 192.168.200.138)
# 集群各 IP 对应的 主机名数组
export NODE_NAMES=(secp-master secp-node1 secp-node2)

# kube-apiserver 的 VIP（HA 组件 keepalived 发布的 IP）
export MASTER_VIP=192.168.200.140
...
# etcd 集群服务地址列表
export ETCD_ENDPOINTS="https://192.168.200.140:2379,https://192.168.200.136:2379,https://192.168.200.138:2379"
# etcd 集群间通信的 IP 和端口
export ETCD_NODES="secp-master=https://192.168.200.140:2380,secp-node1=https://192.168.200.136:2380,secp-node2=https://192.168.200.138:2380"
